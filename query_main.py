    ...
    def search(self):
        ...
        for tier_list in top_tier_docs:
            ...
            for doc in tier_list:
                self.output_text.insert(tk.END, f"#{num_printed} doc_ID: {doc[0]} Score: {doc[1]} Present terms: {document_dictionary[doc[0]]}\n")
...
if __name__ == '__main__':
    ...
    guiChoice = input("Enter GUI if you want to access the gui: ")
    if guiChoice == "GUI":
        guiMain()
    else:
        while(True):
            ...
            for tier_list in top_tier_docs:
                ...
                for doc in tier_list:
                    print(f"#{numPrinted} doc_ID: {doc[0]} Score: {doc[1]} Present terms: {document_dictionary[doc[0]]}")
